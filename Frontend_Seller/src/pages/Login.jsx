...
//     try {
//       const response = await axios.post(backendUrl + "/api/supplier/login", { // Use backendUrl from context
//         emailOrPhone,
//         password,
//       });
...
//         setToken(response.data.token);
//         localStorage.setItem("supplierToken", token); // Store token
//         localStorage.setItem("supplier", JSON.stringify(supplier)); // Store supplier data
