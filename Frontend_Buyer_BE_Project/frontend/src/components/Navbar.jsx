...
// fix the hover on the profile icon


const Navbar = () => {

  const { setShowSearch, getCartCount, token, setToken, setCartItems, setRentalItems, getCartCount_r } = useContext(BuyerContext);
  ...
  return (
    ...
    <div className="flex items-center justify-start sm:justify-between py-5 font-medium">
      ...
      <Link to="/">
        <img src={assets.logo_rensell} className="h-[100px] w-[100px] sm:mr-[0px] mr-[100px] md:h-[150px] md:w-[150px] rounded-lg " alt="" />
      </Link>
      ...
      <ul className='hidden sm:flex gap-5  text-sm text-gray-700'>
        ...
        <NavLink to="/contact" className='flex flex-col items-center gap-1'>
          <p className='sm:text-xl text-red-500'>CONTACT</p>
          <hr className='w-2/4 border-none h-[2px] bg-gray-700 hidden' />
        </NavLink>
